...
final readonly class TableChanged
{
    ...
    public static function from(Connection $connection, Blueprint $blueprint): self
    {
        return new self(
            ...
            addedColumns: static::parseAddedColumns($blueprint),
            droppedColumns: static::parseDroppedColumns($blueprint),
            renamedColumns: static::parseRenamedColumns($blueprint),
            modifiedColumns: static::parseModifiedColumns($blueprint),
            addedIndexes: static::parseAddedIndexes($blueprint),
            droppedIndexes: static::parseDroppedIndexes($blueprint),
            renamedIndexes: static::parseRenamedIndexes($blueprint),
            addedForeignKeys: static::parseAddedForeignKeys($blueprint),
            droppedForeignKeys: static::parseDroppedForeignKeys($blueprint),
        );
    }
}
